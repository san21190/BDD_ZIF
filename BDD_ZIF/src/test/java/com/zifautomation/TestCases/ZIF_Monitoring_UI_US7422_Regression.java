...
public class ZIF_Monitoring_UI_US7422_Regression extends Base {
	...
	@Test
	public void ZIF_Monitoring_UI_US7422_Regression() throws IOException, InterruptedException {

		//Report Initialization

		test = extent.createTest("User Story 7422: GIA - Date range conversion - Device details page.");
		test.createNode("User Story 7422: GIA - Date range conversion - Device details page.");
