...
public class ZIFUI_AnP_US4470_Regression extends Base {



	@Test
	public void ZIFUI_AnP_US4470_Regression() throws IOException, InterruptedException {

		//Report Initialization

		test = extent.createTest("Case Management - Decline Correlation");
		test.createNode("Case Management - Decline Correlation");
		...
		try {
			...
			Thread.sleep(3000);
			if(status==false) {
				test.log(Status.PASS, "Priority is disabled");
...
//---------------------------------End of US------------------------------------------//
		...
		//After clicking on the first row verify Declinecorrelation is enabled and click on it
		//US 4909
		try {
