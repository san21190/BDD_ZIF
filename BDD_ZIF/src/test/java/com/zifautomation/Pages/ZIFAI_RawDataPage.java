...
public class ZIFAI_RawDataPage {

	WebDriver driver;


	public ZIFAI_RawDataPage(WebDriver driver)
	{
		this.driver=driver;
...
//	public WebElement alertSettingsIcon;
	...
	//Validation Message
		...
		@FindBy(how = How.XPATH, using = "//*[contains(text(),'View Details')]")
		public WebElement Deviceviewdetails;
		@FindBy(how = How.XPATH, using = "(//span[contains(@class,'sub-title')]//..//strong)[3]")
		public WebElement DeviceFromdate;
		@FindBy(how = How.XPATH, using = "(//span[contains(@class,'sub-title')]//..//strong)[4]")
		public WebElement DeviceTodate;
		@FindBy(how = How.XPATH, using = "//label[contains(@class,'ui-dropdown-label')]")
		public WebElement Invoketimelabel;
		@FindBy(how = How.XPATH, using = "//span[@class='timeData']")
		public WebElement Invoketimedata;
		@FindBy(how = How.XPATH, using = "//span[contains(@class,'ui-dropdown-trigger-icon')]")
		public WebElement Timedatadropdown;
		@FindBy(how = How.XPATH, using = "//input[contains(@class,'ui-inputtext')]")
		public WebElement Timedatasearchinput;
		@FindBy(how = How.XPATH, using = "//li[contains(@class,'ui-dropdown-item')]")
		public WebElement Timedatadropdownvalue;
...
//	}
	...
	public void DeleteSNMPconfigdetails() throws InterruptedException {
		try {
			int size = new ZIFAI_RawDataPage(driver).DisabledSNMPnameList.size();
			List<WebElement> Listcombo = new ZIFAI_RawDataPage(driver).DisabledSNMPnameList;
			for (int i = 0; i < size; i++) {
				...
				if (snmp.contains("Automode")) {
					new ZIFAI_RawDataPage(driver).SNMPdelete.get(i).click();
					Thread.sleep(3000);
					new ZIFAI_RawDataPage(driver).Deleteconfirmation.click();
					Thread.sleep(3000);
				} else {
	...
	public void DeleteWMIconfigdetails() throws InterruptedException {
		try {
			...
			for (int i = 0; i < size; i++) {
				...
				System.out.println("Value from the configuration disabled text box:" + snmp);
				if (snmp.contains("Automode")) {
					new ZIFAI_RawDataPage(driver).WMIdelete.get(i).click();
					Thread.sleep(3000);
					new ZIFAI_RawDataPage(driver).Deleteconfirmation.click();
					Thread.sleep(3000);
				} else {
	...
	public void DeleteSSHconfigdetails() throws InterruptedException {
		try {
			...
			for (int i = 0; i < size; i++) {
				...
				System.out.println("Value from the configuration disabled text box:" + snmp);
				if (snmp.contains("Automode")) {
					new ZIFAI_RawDataPage(driver).SSHdelete.get(i).click();
					Thread.sleep(3000);
					new ZIFAI_RawDataPage(driver).Deleteconfirmation.click();
					Thread.sleep(3000);
				} else {
	...
	public String Timezoneselector(String value) {
		try {
			if(Invoketimedata.isDisplayed()){
				new ZIFAI_RawDataPage(driver).Invoketimedata.click();
				Thread.sleep(3000);
				new ZIFAI_RawDataPage(driver).Invoketimelabel.click();
				Thread.sleep(3000);
				new ZIFAI_RawDataPage(driver).Timedatasearchinput.sendKeys(value);
				Thread.sleep(3000);
				new ZIFAI_RawDataPage(driver).Timedatadropdownvalue.click();
				Thread.sleep(3000);
			}
			if(Invoketimelabel.isDisplayed()){
				new ZIFAI_RawDataPage(driver).Invoketimelabel.click();
				Thread.sleep(3000);
				new ZIFAI_RawDataPage(driver).Invoketimelabel.click();
				Thread.sleep(3000);
